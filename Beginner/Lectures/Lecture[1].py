...
# :: NOTE : 
# - Python primarily uses snake_case for variables, functions, methods, and module names, as recommended by PEP 8.
#-  For class names, Python uses PascalCase (or CapWords), and for constants, it uses screaming_snake_case (all uppercase with underscores).
# - This convention improves readability and distinguishes between different types of identifiers.
